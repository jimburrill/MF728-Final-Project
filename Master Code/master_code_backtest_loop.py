...
for i in range(int((end - start) / increment) + 1):
    SLOPE_COEFFICIENT = start + i * increment
    ...
    class Optimizer:
        ...
        def get_weights(self):
            ...
            result = minimize(fun=objective_function,
                            ...
                            bounds = bounds,
                            options = {'maxiter': 100000}) # increase number to increase accuracy of optimizer
    ...
    def Backtest():
        ...
        portfolio_returns_df.to_csv(f"backtest_results/Master_Portfolio_Returns{SLOPE_COEFFICIENT}.csv",index=None)
