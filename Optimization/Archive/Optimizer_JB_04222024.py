...
class Optimizer:
    ...
    def get_weights(self):
        ...
        tickers = self.data['Ticker'].values
...
if __name__ == "__main__":
    ...
    temp_data = data[data['Date'] == date_i]
    print(temp_data)
    del data
    ...
    optimizer = Optimizer(temp_data, index_duration) # create optimizer using data on that date, and the index duration
