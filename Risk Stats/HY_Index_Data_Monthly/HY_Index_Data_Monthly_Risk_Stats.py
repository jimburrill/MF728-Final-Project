...
portfolio_data = pd.read_csv('HY_Index_Data_Monthly.csv')

# Adjust risk-free rate
risk_free_rate = portfolio_data['RF']
...
portfolio_data.to_csv('Updated_HY_Index_Data_Monthly.csv', index=False)
