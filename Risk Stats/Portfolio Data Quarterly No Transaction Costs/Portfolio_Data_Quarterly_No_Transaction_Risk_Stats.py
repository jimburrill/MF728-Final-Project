...
portfolio_data = pd.read_csv('Portfolio_Data_NoTransactionCosts_Quarterly.csv')
...
portfolio_data.to_csv('Updated_Portfolio_Data_NoTransactionCosts_Quarterly.csv', index=False)
